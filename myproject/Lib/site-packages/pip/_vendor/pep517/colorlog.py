...
class LogFormatter(Logger.Formatter):
    ...
    def __init__(self, color=True, datefmt=None):
        ...
        :arg dict colors: color mappings from Logger level to terminal color
        code
        ...
        """
        Logger.Formatter.__init__(self, datefmt=datefmt)
        self._colors = {}
        if color and _stderr_supports_color():
            # The curses module has some str/bytes confusion in
            # python3. Until version 3.2.3, most methods return
            # bytes, but only accept strings. In addition, we want to
            # output these strings with the Logger module, which
...
def enable_colourful_output(level=Logger.INFO):
