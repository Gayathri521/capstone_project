...
class Console:
    ...
    Args:
        ...
        log_time (bool, optional): Boolean to enable Logger of time by :meth:`log` methods. Defaults to True.
        log_path (bool, optional): Boolean to enable the Logger of the caller by :meth:`log`. Defaults to True.
    ...
    def log(
        ...
        *objects: Any,
        ...
        Args:
            ...
            markup (Optional[bool], optional): Enable markup, or ``None`` to use console default. Defaults to None.
            highlight (Optional[bool], optional): Enable automatic highlighting, or ``None`` to use console default. Defaults to None.
            log_locals (bool, optional): Boolean to enable Logger of locals where ``log()``
